import pygame
from settings import FPS, player_one_projectiles, player_two_projectiles, player_two_health, player_one_health, WIN
...
from shooting_logic import handle_player_one_shooting, handle_player_two_shooting, handle_projectiles
...
def main():
    ...
    while run:
        ...
        winner = check_winner(player_two_health, player_one_health, player_two, player_one, player_two_projectiles, player_one_projectiles)

        keys_pressed = pygame.key.get_pressed()
        player_one_handle_movement(keys_pressed, player_one)
        player_two_handle_movement(keys_pressed, player_two)
        handle_projectiles(player_one_projectiles, player_two_projectiles, player_one, player_two)
        draw_window(player_two, player_one, player_two_projectiles, player_one_projectiles, player_two_health, player_one_health)
